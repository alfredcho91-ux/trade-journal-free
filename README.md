...
거래 리포트는 월간 Anchored VWAP을 HLC3 기준으로 계산하고, 최근 완료봉 14개의 표준편차로 1σ·2σ·3σ 밴드와 현재가의 VWAP 대비 편차를 표시합니다. 결과는 중심권, 상단/하단 확장, 극단적 이격으로 쉽게 구분되며, 기존 VPVR·롤링 VWAP 기능과 분리되어 동작합니다.
