...
def test_free_edition_exposes_only_journal_analysis_routes():
    ...
    expected = {
        ...
        ("POST", "/api/review/trading"),
        ("POST", "/api/review/patterns"),
        ("POST", "/api/review/strategy-execution"),
        ("GET", "/api/experiments"),
        ("POST", "/api/experiments"),
        ("GET", "/api/experiments/{identifier}"),
        ("PATCH", "/api/experiments/{identifier}"),
        ("POST", "/api/experiments/{identifier}/transition"),
        ("GET", "/api/experiments/{identifier}/measurement"),
